...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-nav">
            ...
            <!-- dropdown end -->
            <a href="dapen.php">Data Penduduk</a>
        ...
        <div class="row">
            <div class="buddha-table">
                <table id="buddha">
                    ...
                    $sql = 'SELECT * FROM rumah_ibadah_budha';
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo '<tr>';
                            echo '<td>' . $row['id'] . '</td>';
                            echo '<td>' . $row['Nama_Rumah_Ibadah'] . '</td>';
        ...
        <div class="row">
            <div class="buddha-table">
                <table id="hindu">
                    ...
                    $sql = 'SELECT * FROM rumah_ibadah_hindu';
                    $result = $conn->query($sql);
        ...
        <div class="row">
            <div class="buddha-table">
                <table id="kristen">
                    ...
                    $sql = 'SELECT * FROM rumah_ibadah_kristen';
                    $result = $conn->query($sql);
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo '<tr>';
                            echo '<td>' . $row['id'] . '</td>';
                            echo '<td>' . $row['nama tempat ibadah'] . '</td>';
                            echo '<td>' . $row['jenis'] . '</td>';
                            echo '<td>' . $row['alamat'] . '</td>';
        ...
        <div class="row">
            <div class="buddha-table">
                <table id="katholik">
                    ...
                    $sql = 'SELECT * FROM rumah_ibadah_khatolik';
                    $result = $conn->query($sql);
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td>' . $row['id'] . '</td>';
                            echo '<td>' . $row['Nama_Rumah_Ibadah'] . '</td>';
                            echo '<td>' . $row['Paroki'] . '</td>';
                            echo '<td>' . $row['Keuskupan'] . '</td>';
                            echo '<td>' . $row['Alamat'] . '</td>';
                            echo '<td>' . $row['Kab'] . '</td>';
                            echo '</tr>';
                        }
    ...
    <footer>
        ...
        <div class="credit">
            <p>Created by <a href="#">R.kenny</a>. | &copy; 2023.</p>
        </div>
    </footer>
    <!-- footer -->
